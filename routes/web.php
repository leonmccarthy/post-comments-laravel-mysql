...
Route::middleware('auth')->group(function(){
    ...
    Route::get('/post/edit/{post}', [PostController::class, 'editPostView'])->name('editPostView');
    Route::post('/post/edit/{post}', [PostController::class, 'editPostAction'])->name('editPostAction');
});
